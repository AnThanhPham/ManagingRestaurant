...
using ManagingRestaurant.Areas.Identity.Models.AccountViewModels;
using ManagingRestaurant.Areas.Identity.Models.ManageViewModels;
using ManagingRestaurant.Areas.Identity.Models.RoleViewModels;
using ManagingRestaurant.Areas.Identity.Models.UserViewModels;
using ManagingRestaurant.Data;
using ManagingRestaurant.ExtendMethods;
...
namespace ManagingRestaurant.Areas.Identity.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, RestaurantContext context, UserManager<AppUser> userManager)
        {
            _logger = logger;
